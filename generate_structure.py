...
if __name__ == "__main__":
    # The directory to analyze (adjusting to look at project root)
    target_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '../nourish_PT'))
    ...
    try:
        ...
        print(f"File structure for '{os.path.basename(target_dir)}':")
