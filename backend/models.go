...
type ScoreOverrides struct {
	...
	// Entrepreneur Overrides (What-If Scenario variables)
...
// NAICS Industry Matrices defining factor sensitivity
...
var IndustryMatrices = map[string]NAICSMatrix{
	...
	// 311 Food Mfg (Bakeries)
	"311812": {fR: 1.10, fE: 1.25, fL: 1.20, fP: 1.20, fReg: 1.25, fS: 1.10, fScale: 1.10},
}

// Fallback multiplier map for generic 3-digit prefixes
